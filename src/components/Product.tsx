...
const ProductComponent = (props: IProduct) => {
    ...
    const likeColor = isLiked ? '#414141':'#fffff'
    return (
        <div className='product__inner'>
            <div className="product__image">
                <img src={`https://testbackend.nc-one.com${props.src}`} alt="product" width={200} height={200}/>
            </div>
            ...
            <div className="description">
                ...
                <div className='product__btn' >
                    <svg onClick={() => {
                        setIsLiked(!isLiked)
                        dispatch({type: 'addToFavorites', payload: props})
