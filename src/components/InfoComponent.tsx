...
const InfoComponent = () => {
    ...
    const likeHandler = () => {
        if (!isLiked) {
            dispatch({type: 'addToFavorites', payload: id})
        } else {
    ...
    const scaledStyle = isScaled ? 'scaled' : 'info__image';
    return (<>

            {product && <div className='info__inner'>
                <div className="image__wrapper">
                    <div className={scaledStyle}>
                        <img onClick={() => {
                            setIzScaled(false)
                        }} src={`https://testbackend.nc-one.com${product.src}`} alt="product" width={448} height={448}/>
                    </div>
                    {!isScaled && <div className='info__clarity' onClick={() => {
                        setIzScaled(pre => !pre)
                    }}>
                ...
                <div className="info__info">
                    ...
                    <div className="description">
                        ...
                        <svg onClick={likeHandler}
                            ...
                            <rect x="8.16675" y="8.16669" width="81.6667" height="81.6667" rx="7" fill={likeColor}/>
                            <path
